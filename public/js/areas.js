...
var userTable = $('#AreasTable').DataTable({
    ...
    columns: [
        ...
        {data: 'pincode', name: 'pincode',orderable: true},
...
jQuery(function(){
    var m=document.getElementById('AreaModel'),table=document.getElementById('AreasTable');
    var rack_types = {
        init: function() {
